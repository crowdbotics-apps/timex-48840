"""
Django settings for timex_48840 project.
...
WSGI_APPLICATION = 'timex_48840.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Timex Support <support@timex-48840.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "timex_48840 API",
    "DESCRIPTION": "API documentation for timex_48840 App",
    "VERSION": "v1",
}
